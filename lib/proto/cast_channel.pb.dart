...
class CastMessage extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CastMessage',
      package: const $pb.PackageName('extensions.api.cast_channel'))
    ..e<CastMessage_ProtocolVersion>(
        1,
        'protocolVersion',
        $pb.PbFieldType.QE,
        CastMessage_ProtocolVersion.CASTV2_1_0,
        CastMessage_ProtocolVersion.valueOf,
        CastMessage_ProtocolVersion.values)
    ..aQS(2, 'sourceId')
    ..aQS(3, 'destinationId')
    ..aQS(4, 'namespace')
    ..e<CastMessage_PayloadType>(
        ...
        CastMessage_PayloadType.valueOf,
        CastMessage_PayloadType.values)
    ..aOS(6, 'payloadUtf8')
    ..a<$core.List<$core.int>>(7, 'payloadBinary', $pb.PbFieldType.OY);

  CastMessage() : super();
  CastMessage.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  CastMessage.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
  ...
  set protocolVersion(CastMessage_ProtocolVersion v) {
    setField(1, v);
  }
  ...
  set payloadType(CastMessage_PayloadType v) {
    setField(5, v);
  }
  ...
  set payloadBinary($core.List<$core.int> v) {
    $_setBytes(6, v);
  }
...
class AuthChallenge extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AuthChallenge',
      package: const $pb.PackageName('extensions.api.cast_channel'))
    ..hasRequiredFields = false;

  AuthChallenge() : super();
  AuthChallenge.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  AuthChallenge.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
...
class AuthResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AuthResponse',
      package: const $pb.PackageName('extensions.api.cast_channel'))
  ...
  AuthResponse() : super();
  AuthResponse.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  AuthResponse.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
  ...
  set clientAuthCertificate($core.List<$core.int> v) {
    $_setBytes(1, v);
  }
...
class AuthError extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AuthError',
      package: const $pb.PackageName('extensions.api.cast_channel'))
    ..e<AuthError_ErrorType>(
        1,
        'errorType',
        $pb.PbFieldType.QE,
        AuthError_ErrorType.INTERNAL_ERROR,
        AuthError_ErrorType.valueOf,
        AuthError_ErrorType.values);

  AuthError() : super();
  AuthError.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  AuthError.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
  AuthError clone() => AuthError()..mergeFromMessage(this);
  AuthError copyWith(void Function(AuthError) updates) =>
      super.copyWith((message) => updates(message as AuthError));
  $pb.BuilderInfo get info_ => _i;
  ...
  set errorType(AuthError_ErrorType v) {
    setField(1, v);
  }
...
class DeviceAuthMessage extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DeviceAuthMessage',
      package: const $pb.PackageName('extensions.api.cast_channel'))
    ..a<AuthChallenge>(1, 'challenge', $pb.PbFieldType.OM,
        AuthChallenge.getDefault, AuthChallenge.create)
    ..a<AuthResponse>(2, 'response', $pb.PbFieldType.OM,
        AuthResponse.getDefault, AuthResponse.create)
    ..a<AuthError>(
        3, 'error', $pb.PbFieldType.OM, AuthError.getDefault, AuthError.create);

  DeviceAuthMessage() : super();
  DeviceAuthMessage.fromBuffer($core.List<$core.int> i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromBuffer(i, r);
  DeviceAuthMessage.fromJson($core.String i,
      [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY])
      : super.fromJson(i, r);
